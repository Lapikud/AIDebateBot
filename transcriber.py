...
try:
    ...
    write_to_file("humanity_speeches", current_full_transcript, "a")
    ...
    try:
        ...
        print(Fore.RED + "prompt.txt not found! Create the file first.")
        exit()

    # Send to AI
    ai_reply = send_text_to_ai(system_prompt, current_full_transcript)
    write_to_file("ai_speeches", ai_reply, "a")
    print(Fore.CYAN + "\n========== AI RESPONSE ==========\n")
    print(ai_reply)
    print("\n=================================\n")
